...
There are different legal reasoning/analysis methods, but professionals most commonly engage in both (1) [**deductive reasoning**](introduction-to-deductive-rule-based-reasoning.md#introduction) (i.e., syllogistic reasoning) and (2) **inductive reasoning** (in our context, this is reasoning by analogy).&#x20;
...
Here is an [example ](#user-content-fn-10)[^10]of a polysyllogism based on the Socrates syllogism, and the issue is whether Socrates is a god:
...
In their arguments, many people use [**enthymemes**](#user-content-fn-11)[^11]**,** which are implicit premises. Generally, arguers will use enthymemes for efficiency when they presume that the omitted premise is obvious[^12].&#x20;

In daily conversations, political arguments, legal reasoning (including [judicial opinions](#user-content-fn-12)[^12]), etc., enthymemes are common. For example[^13]:
...
Introduction to Deductive (Rule-Based) Reasoning © 2024 by Matthew L. Mac Kelly is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/?ref=chooser-v1), except where otherwise noted.
...
[^6]: [Fields (2024)](../sources-referenced-in-annotations.md).

[^7]: [Fields ](../sources-referenced-in-annotations.md)[(2024)](../sources-referenced-in-annotations.md).
...
[^11]: [Aldisert et al.](../sources-referenced-in-annotations.md), 8; [Nordquist](../sources-referenced-in-annotations.md)[ (2018)](../sources-referenced-in-annotations.md).

[^12]: Ruggero J. Aldisert, Stephen Clowney, & Jeremy D. Peterson, _Logic for Law Students: How to Think Like a Lawyer_. [69 U. PITT. L. REV. 1](https://doi.org/10.5195/lawreview.2007.117), 8 (2007).

[^13]: Literary Terms, [_Enthymeme_](https://literaryterms.net/enthymeme/) (last visited June 20, 2024).

[^14]: [Aldisert et al.](../sources-referenced-in-annotations.md), 8.

[^15]: [Ramee ](../sources-referenced-in-annotations.md)(2002); [Nordquist ](../sources-referenced-in-annotations.md)(2019).

[^16]: Literary Terms, [_Enthymeme_](https://literaryterms.net/enthymeme/) (last visited June 20, 2024).

[^17]: See, generallly, [Ramee (2002)](../sources-referenced-in-annotations.md).
